...
export default function Home() {
  ...
  // const docWebsites: Websites[] = require('./api/websites/docWebsites.json')
  // const Websites = [aiWebsites, designWebsites, docWebsites]
  // const WebsiteTitle = ["Ai", "Design", "Docs"]
        ...
        <div className='flex flex-col' >
          ...
          {Object.values(WebsitesArray).map((websites, index) => (
            <div key={index}>
              ...
              <div className='grid grid-flow-col-dense mb-20 mt-4 last:mr-2'>
